...

{
    ...
    function buildUI(thisObj) {
        ...
        var attractSlider = m5.add("slider", undefined, 0, 0, 15);
        ...
        attractValue.onChange = function() { var v = parseFloat(attractValue.text); if (!isNaN(v)) attractSlider.value = Math.max(0, Math.min(15, v)); };
